    ...
    public sealed class BirdSongs : BaseEvent
    {
        ...
        public override void StartEvent()
        {
            ...
            var eventOption1 = new TextObject(
                    "{=BirdSongs_Event_Text}This day has been blessed by the beautiful melodies of birds singing songs. Silence falls over your ranks as the relaxing sounds of " +
