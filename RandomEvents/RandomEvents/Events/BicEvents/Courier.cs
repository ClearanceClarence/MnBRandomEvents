...
namespace Bannerlord.RandomEvents.Events.BicEvents
{
    public sealed class Courier : BaseEvent
    {
        ...
        public override void StartEvent()
        {
            ...
            var eventOption1 =
                new TextObject(
                        "{=Courier_Event_Text}A courier has arrived with a handful of letters for {heroName}'s party. The men seem quite excited, at least those who know how to read.")
