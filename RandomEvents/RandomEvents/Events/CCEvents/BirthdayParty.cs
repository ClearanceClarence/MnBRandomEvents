    ...
    public sealed class BirthdayParty : BaseEvent
    {
        ...
        public override bool CanExecuteEvent()
        {
            return HasValidEventData() && MobileParty.MainParty.MemberRoster.TotalRegulars >= maxYourMenAttending &&
                   MobileParty.MainParty.CurrentSettlement == null && Hero.MainHero.Gold > maxGoldGiven;
        }
        ...
        public override void StartEvent()
        {
            ...
            var eventOption1Hover =
                new TextObject("{=BirthdayParty_Event_Option_1_Hover}Not everyday you turn {birthdayAge} years old!")
                    .SetTextVariable("birthdayAge", birthdayAge).ToString();

            var eventOption2 = new TextObject("{=BirthdayParty_Event_Option_2}Give the girl some gold").ToString();
            var eventOption2Hover =
                new TextObject(
                        "{=BirthdayParty_Event_Option_2_Hover}You don't have time to stay but you can still be nice, right?")
                    .ToString();

            var eventOption3 = new TextObject("{=BirthdayParty_Event_Option_3}Move on").ToString();
            var eventOption3Hover =
                new TextObject("{=BirthdayParty_Event_Option_3_Hover}You don't have time").ToString();

            var eventOption4 = new TextObject("{=BirthdayParty_Event_Option_4}[Roguery] Raid the party").ToString();
            var eventOption4Hover =
                new TextObject("{=BirthdayParty_Event_Option_4_Hover}Have some fun.\n{rogueryAppendedText}")
                    ...
                    switch ((string)elements[0].Identifier)
                    {
                        case "a":
                            InformationManager.ShowInquiry(
                                new InquiryData(eventTitle, eventOptionAText, true, false, eventButtonText, null, null,
                                    null), true);
                        ...
                        case "b":
                            InformationManager.ShowInquiry(
                                new InquiryData(eventTitle, eventOptionBText, true, false, eventButtonText, null, null,
                                    null), true);
                            Hero.MainHero.ChangeHeroGold(-goldGiven);
                        ...
                        case "c":
                            InformationManager.ShowInquiry(
                                new InquiryData(eventTitle, eventOptionCText, true, false, eventButtonText, null, null,
                                    null), true);
                            MobileParty.MainParty.MoraleExplained.Add(-5);
                        ...
                        case "d":
                            InformationManager.ShowInquiry(
                                new InquiryData(eventTitle, eventOptionDText, true, false, eventButtonText, null, null,
                                    null), true);
                            Hero.MainHero.ChangeHeroGold(+goldGiven);
