...
namespace Bannerlord.RandomEvents.Events.CCEvents
{
    public sealed class RedMoon : BaseEvent
    {
        ...
        {
            return HasValidEventData() && MobileParty.MainParty.MemberRoster.TotalRegulars >= maxMenLost &&
        ...
        public override void StartEvent()
        {
            ...
            var eventOption1Hover =
                new TextObject("{=RedMoon_Event_Option_1_Hover}This really **is** the end!").ToString();

            var eventOption2 = new TextObject("{=RedMoon_Event_Option_2}Call your men to you").ToString();
            var eventOption2Hover =
                new TextObject("{=RedMoon_Event_Option_2_Hover}Let's talk instead of acting like idiots").ToString();
            ...
            var eventOption4Hover =
                new TextObject("{=RedMoon_Event_Option_4_Hover}Just head back to your tent").ToString();
                ...
                elements =>
                {
                    switch ((string)elements[0].Identifier)
                    {
                        ...
                        case "b":
                            ...
                            Hero.MainHero.ChangeHeroGold(-goldLostToReligion);
                            MobileParty.MainParty.MemberRoster.RemoveNumberOfNonHeroTroopsRandomly(menLostToReligion);
