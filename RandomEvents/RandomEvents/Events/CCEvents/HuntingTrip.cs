...
namespace Bannerlord.RandomEvents.Events.CCEvents
{
    public sealed class HuntingTrip : BaseEvent
    {
        ...
        {
            if (!eventDisabled)
                if (minSoldiersToGo != 0 || maxSoldiersToGo != 0 || maxCatch != 0 || minMoraleGain != 0 ||
                    maxMoraleGain != 0 || minYieldMultiplier != 0 || maxYieldMultiplier != 0)
                    return true;
        ...
        public override void StartEvent()
        {
            ...
            InformationManager.ShowInquiry(
                new InquiryData(eventTitle, eventDescription, true, false, eventButtonText, null, null, null), true);
            ...
            {
                InformationManager.ShowInquiry(
                    new InquiryData(eventTitle, eventOutcome1, true, false, eventButtonText, null, null, null), true);
            ...
            {
                InformationManager.ShowInquiry(
                    new InquiryData(eventTitle, eventOutcome2, true, false, eventButtonText, null, null, null), true);
            ...
            {
                InformationManager.ShowInquiry(
                    new InquiryData(eventTitle, eventOutcome3, true, false, eventButtonText, null, null, null), true);
            ...
            {
                InformationManager.ShowInquiry(
                    new InquiryData(eventTitle, eventOutcome4, true, false, eventButtonText, null, null, null), true);
