...
namespace Bannerlord.RandomEvents.Events.CCEvents
{
    public class LightsInTheSkies : BaseEvent
    {
        ...
        {
            return HasValidEventData() && !GeneralSettings.SciFiEvents.IsDisabled() && CurrentTimeOfDay.IsNight;
        }
        ...
        public override void StartEvent()
        {
            ...
            const string unknownText =
                "46 62 54 75 42 46 66 45 64 42 57 66 42 64 46 50 62 42 68 66 46 62 46 84 42 46 " +
            ...
            InformationManager.ShowInquiry(
                new InquiryData(eventTitle, eventText1, true, false, eventButtonText1, null, null, null), true);
            InformationManager.ShowInquiry(
                new InquiryData(eventTitle, eventText2, true, false, eventButtonText1, null, null, null), true);
            InformationManager.ShowInquiry(
                new InquiryData(eventTitle, eventText3, true, false, eventButtonText1, null, null, null), true);
            InformationManager.ShowInquiry(
                new InquiryData(eventTitle, eventText4, true, false, eventButtonText2, null, null, null), true);
            InformationManager.ShowInquiry(
                new InquiryData(eventTitle, eventTextUnknown, true, false, eventButtonText3, null, null, null), true);
            InformationManager.ShowInquiry(
                new InquiryData(eventTitle, eventText5, true, false, eventButtonText2, null, null, null), true);
