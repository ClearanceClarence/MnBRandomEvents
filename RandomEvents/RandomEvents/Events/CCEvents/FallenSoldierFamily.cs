...
namespace Bannerlord.RandomEvents.Events.CCEvents
{
    public sealed class FallenSoldierFamily : BaseEvent
    {
        ...
        {
            if (!eventDisabled)
                if (minFamilyCompensation != 0 || maxFamilyCompensation != 0 || minGoldLooted != 0 ||
        ...
        public override bool CanExecuteEvent()
        {
            return HasValidEventData() &&
                   ...
                   MobileParty.MainParty.MemberRoster.TotalRegulars >= 100;
        }
        ...
        public override void StartEvent()
        {
            ...
            var eventOption1Hover = new TextObject("{=FallenSoldier_Event_Option_1_Hover}They should be compensated")
                .ToString();

            var eventOption2 = new TextObject("{=FallenSoldier_Event_Option_2}Explain that you owe them nothing")
                .ToString();
            ...
            var eventOption3Hover =
                new TextObject("{=FallenSoldier_Event_Option_3_Hover}You have a headache so you leave").ToString();

            var eventOption4 = new TextObject("{=FallenSoldier_Event_Option_4}[Roguery] Trick them").ToString();
            var eventOption4Hover = new TextObject("{=FallenSoldier_Event_Option_4_Hover}{rogueryAppendedText}")
            ...
            if (plotEvil) inquiryElements.Add(new InquiryElement("d", eventOption4, null, true, eventOption4Hover));
