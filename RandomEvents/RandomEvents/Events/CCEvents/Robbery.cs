...
namespace Bannerlord.RandomEvents.Events.CCEvents
{
    public sealed class Robbery : BaseEvent
    {
        ...
        {
            if (!eventDisabled)
                if (minGoldLost != 0 || maxGoldLost != 0 || minRoguerySkill != 0 || minCharmSkill != 0 ||
                    minOneHandedSkill != 0 || minTwoHandedSkill != 0)
                    return true;
        ...
        public override void StartEvent()
        {
            ...
            var gangLeaderGenderAdjective =
                GenderAssignment.GetTheGenderAssignment(gangLeaderGender, false, "adjective");
            var gangLeaderGenderSubjective =
                GenderAssignment.GetTheGenderAssignment(gangLeaderGender, false, "subjective");

            var gangLeaderName = gangLeader.Name.ToString();

            var gangLeaderRelation = gangLeader.GetBaseHeroRelation(Hero.MainHero);

            if (gangLeaderRelation >= 50) gangLeaderGoodRelation = true;
            ...
            if (!charmedThugs && !convincedThugs && !intimidatedThugs && !gangLeaderGoodRelation)
            {
                InformationManager.ShowInquiry(
                    new InquiryData(eventTitle, eventText_Bad_Outcome, true, false, eventButtonText, null, null, null),
                    true);
            ...
            {
                InformationManager.ShowInquiry(
                    new InquiryData(eventTitle, eventText_Convinced_Outcome, true, false, eventButtonText, null, null,
                        null), true);
            ...
            {
                InformationManager.ShowInquiry(
                    new InquiryData(eventTitle, eventText_Charmed_Outcome, true, false, eventButtonText, null, null,
                        null), true);
            ...
            {
                InformationManager.ShowInquiry(
                    new InquiryData(eventTitle, eventText_Intimidated_Outcome, true, false, eventButtonText, null, null,
                        null), true);
            ...
            {
                InformationManager.ShowInquiry(
                    new InquiryData(eventTitle, eventText_Good_Relation_Outcome, true, false, eventButtonText, null,
                        null, null), true);
