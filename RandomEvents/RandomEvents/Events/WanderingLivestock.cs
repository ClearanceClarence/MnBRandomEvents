    ...
    public sealed class WanderingLivestock : BaseEvent
    {
        ...
        public override void StartEvent()
        {
            ...
            var eventDescription =
                new TextObject("{=WanderingLivestock_Event_Desc}You come across some wandering livestock.")
                    .ToString();
                    ...
                    switch ((string)elements[0].Identifier)
                    {
                        case "a":
                        {
                            ...
                            if (cowCount > 0)
                            {
                                ...
                                var eventCowText =
                                    new TextObject(
                                            "{=WanderingLivestock_Event_Cow_Text}, and {cowCount} cow{cowPlural}.")
                            ...
                            var eventOptionAText =
                                new TextObject(
                                        "{=WanderingLivestock_Event_Choice_1}Who could say no to such a delicious -- I mean, reasonable proposition? You end up in possession of {sheepCount} sheep{cowText}")
                        ...
                        case "b":
                            ...
                            InformationManager.ShowInquiry(
                                new InquiryData(eventTitle, eventOptionBText, true, false, eventButtonText3, null, null,
                                    null), true);
                            break;
                        default:
